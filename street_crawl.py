...
API_KEY_DIRECTIONS = # your api key
API_KEY_STREETVIEW = # your api key
...
For example, to make a one-second video of the entrance of Joshua Treet National Park:
	python2 ./street_crawl.py 33.669793 -115.802125 33.671796 -115.801851 joshua_tree "640x320"
...
def main(lat_lon_A, lat_lon_B, filestem, picsize):
	...
	directions_result = gd.directions(origin=lat_lon_A, destination=lat_lon_B, mode="walking")
